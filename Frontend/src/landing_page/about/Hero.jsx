    ...
    <div className="container">
      ...
      <div className="row p-5 text-muted" style={{lineHeight:"1.8"}}>
        ...
        <div className="col-6 p-5">
          ...
          <p>
            <span>
              <Link className="text-decoration-none">Rainmatter</Link>
            </span>
          ...
          <p>
            ...
            <span>
              <Link className="text-decoration-none">saying about us</Link>
            </span>{" "}
            or learn more about our business and product{" "}
            <span>
              <Link className="text-decoration-none">philosophies</Link>
            </span>
            .
          </p>
        </div>
